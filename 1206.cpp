...
{
    Skiplist *skiplist;
    vector<string> commands{"Skiplist", "add", "add", "add", "search", "add", "search", "erase", "erase", "search"};
    vector<vector<int>> parameters{{}, {1}, {2}, {3}, {0}, {4}, {1}, {0}, {1}, {1}};
